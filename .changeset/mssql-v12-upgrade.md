---
'@utaba/deep-memory-storage-sqlserver': minor
---

Upgrade `mssql` runtime dependency to v12 (was v11). Consumers sharing a `ConnectionPool` with their own `mssql` install must upgrade to `mssql@12`.
